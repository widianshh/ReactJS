            ...
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#6173E6] text-center hover:bg-[#5969cf] text-white active:bg-[#4956ab] rounded-2xl"
                  >
                ...
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#9A9A9A] text-center rounded-2xl"
                  >
                    <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-white" />
